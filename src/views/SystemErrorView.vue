<template>
  <div
    class="min-h-screen w-full flex items-center justify-center bg-gradient-to-br from-red-50 via-orange-50 to-red-100 dark:from-gray-900 dark:via-red-900 dark:to-red-800 p-4">
    <div class="max-w-2xl w-full text-center">
      ...
      <div class="mb-8 flex justify-center">
        <div class="relative">
          ...
          <!-- Main Icon Container -->
          <div
            class="relative bg-white dark:bg-gray-800 rounded-full p-8 shadow-2xl border-4 border-red-200 dark:border-red-700">
            <svg xmlns="http://www.w3.org/2000/svg" class="h-32 w-32 text-red-500 dark:text-red-400" fill="none"
          ...
          <!-- Floating Elements -->
          <div
            class="absolute -top-4 -right-4 w-16 h-16 bg-orange-400 dark:bg-orange-500 rounded-full opacity-70 animate-bounce"
            style="animation-delay: 0.2s;"></div>
          <div
            class="absolute -bottom-4 -left-4 w-12 h-12 bg-red-300 dark:bg-red-600 rounded-full opacity-70 animate-bounce"
      ...
      <!-- Error Code -->
      <h2
        class="text-6xl md:text-7xl font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-red-500 via-orange-500 to-red-600 dark:from-red-400 dark:via-orange-400 dark:to-red-500 mb-4">
        {{ errorCode || 'ERROR' }}
      </h2>
