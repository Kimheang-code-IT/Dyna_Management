  ...
  <div :class="['mx-auto transition-all duration-300', isSidebarCollapsed ? 'max-w-full px-2' : 'max-w-7xl']">
    ...
    <div class="grid grid-cols-1 md:grid-cols-4 gap-3 mb-3">
      ...
      <div class="bg-white dark:bg-gray-800 rounded-sm shadow p-3">
        <div class="flex items-center justify-between">
          <div>
            <h3 class="text-gray-600 dark:text-gray-400 text-sm font-medium mb-2">{{ t('activeUsers') }}</h3>
      ...
      <div class="bg-white dark:bg-gray-800 rounded-sm shadow p-3">
        <div class="flex items-center justify-between">
          <div>
            <h3 class="text-gray-600 dark:text-gray-400 text-sm font-medium mb-2">{{ t('maleUsers') }}</h3>
      ...
      <div class="bg-white dark:bg-gray-800 rounded-sm shadow p-3">
        <div class="flex items-center justify-between">
          <div>
            <h3 class="text-gray-600 dark:text-gray-400 text-sm font-medium mb-2">{{ t('femaleUsers') }}</h3>
      ...
      <div class="bg-white dark:bg-gray-800 w-[500px] h-full shadow-xl overflow-y-auto">
        ...
        <div class="sticky top-0 bg-white dark:bg-gray-800 text-black dark:text-white px-6 py-5 flex items-center justify-between z-10 border-b border-gray-200 dark:border-gray-700">
          <div class="flex items-center gap-3">
            ...
            <h2 class="text-xl font-bold text-black dark:text-white">{{ isEditMode ? t('editUser') : t('addUser') }}</h2>
          </div>
          <button
            @click="closeDrawer"
    ...
    <Transition name="toast">
      <div
        ...
        class="fixed top-4 right-4 bg-green-500 text-white px-6 py-4 rounded-sm shadow-lg z-50 flex items-center gap-3 min-w-[300px]"
      >
...
const confirmDelete = () => {
  if (userToDelete.value) {
    ...
    if (index !== -1) {
      ...
      successMessage.value = t('userDeletedSuccess')
      setTimeout(() => {
...
const handleSubmit = () => {
  if (isEditMode.value) {
    ...
    if (index !== -1) {
      ...
      showSuccessMessage.value = true
      successMessage.value = t('userUpdatedSuccess')
      setTimeout(() => {
        showSuccessMessage.value = false
      }, 3000)
    }
    ...
    showSuccessMessage.value = true
    successMessage.value = t('userAddedSuccess')
    setTimeout(() => {
      showSuccessMessage.value = false
    }, 3000)
  }
