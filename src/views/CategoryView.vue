  ...
  <div
    ...
    <div class="flex flex-nowrap sm:flex-wrap gap-1 sm:gap-1.5 md:gap-2 lg:gap-3 mb-2 sm:mb-3">
      ...
      <div
        ...
        <div
          ...
          <div
            class="w-10 h-10 sm:w-8 sm:h-8 md:w-10 md:h-10 lg:w-12 lg:h-12 bg-purple-100 dark:bg-purple-900/30 rounded-full flex items-center justify-center flex-shrink-0 order-1 sm:order-2 mb-2 sm:mb-0 ml-2 sm:ml-4">
            <svg xmlns="http://www.w3.org/2000/svg"
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-3">
      ...
      <div class="lg:col-span-1 bg-white dark:bg-gray-800 shadow rounded-sm p-3">
        <h2 class="text-xl font-semibold text-gray-800 dark:text-white mb-6 p-3 border-b border-gray-300 capitalize">
        ...
        <form @submit.prevent="handleSubmit" class="space-y-6">
          ...
          <div>
            ...
            <input id="name" v-model="form.name" type="text" required
              @input="validateTextField('name', form.name, { required: true, minLength: 2, maxLength: 100 })"
              :placeholder="t('categoryPlaceholder')" :class="[
          ...
          <div>
            ...
            <textarea id="description" v-model="form.description" rows="8"
              @input="validateTextField('description', form.description, { required: false, minLength: 0, maxLength: 500 })"
              :placeholder="t('descriptionPlaceholder')" :class="[
                'w-full px-3 py-2 border rounded-sm focus:outline-none focus:ring-2 focus:border-transparent bg-white dark:bg-gray-800/100 text-gray-900 dark:text-white placeholder-gray-400 dark:placeholder-gray-400',
      ...
      <div class="lg:col-span-2 bg-white dark:bg-gray-800  rounded-sm shadow p-3">
        ...
        <div class="p-0 mb-2 sm:mb-3 flex flex-col sm:flex-row items-stretch sm:items-center gap-2 sm:gap-3">
          ...
          <div class="flex flex-col sm:flex-row items-stretch sm:items-center gap-2">
            <label
              class="text-xs sm:text-sm font-medium text-gray-700 dark:text-gray-300 whitespace-nowrap self-center sm:self-auto">{{
                t('dateBetween') }}:</label>
            <input v-model="filterDateFrom" type="date"
              class="px-3 py-2  border text-xs border-gray-300 dark:border-gray-600 rounded-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent bg-white dark:bg-gray-800/100 text-gray-900 dark:text-white h-[37px] w-[115px] " />
              ...
              <tr v-for="(category, index) in filteredCategories" :key="category.id"
                ...
                <td class="px-4 py-3 whitespace-nowrap text-xs font-medium text-gray-900 dark:text-white">
                  <div class="flex items-center gap-2">
                    <div
                      class="w-8 h-8 rounded-full flex items-center justify-center text-white font-semibold text-[10px]"
      ...
      <div class="bg-white dark:bg-gray-800 rounded-sm shadow-xl p-6 max-w-md w-full mx-4">
        <div class="flex-1">
          ...
          <div class="flex items-center gap-2 mb-3">
            ...
            <h3 class="text-lg font-semibold text-gray-900 dark:text-white capitalize">{{ t('add') }} {{ t('category')
            }}</h3>
          </div>

          <!-- Description -->
          <p class="text-sm text-gray-600 dark:text-gray-400 mb-3">{{ t('areYouSure') }} {{ t('add') }} {{ t('category')
          }}?</p>
      ...
      <div class="bg-white dark:bg-gray-800 rounded-sm shadow-xl p-6 max-w-md w-full mx-4">
        <div class="flex-1">
          ...
          <div class="flex items-center gap-2 mb-3">
            ...
            <h3 class="text-lg font-semibold text-gray-900 dark:text-white capitalize">{{ t('updateCategory') }}</h3>
          </div>
      ...
      <div class="bg-white dark:bg-gray-800 rounded-sm shadow-xl p-6 max-w-md w-full mx-4">
        <div class="flex-1">
          ...
          <div class="flex items-center gap-2 mb-3">
            ...
            <h3 class="text-lg font-semibold text-gray-900 dark:text-white capitalize">{{ t('deleteCategory') }}</h3>
          </div>
...
const filteredCategories = computed(() => {
  ...
  if (searchQuery.value) {
    filtered = filtered.filter(cat =>
      textContains(cat.name, searchQuery.value) ||
      textContains(cat.description || '', searchQuery.value)
    )
  }
...
const validateForm = () => {
  ...
  if (!validateTextField('name', form.name, { required: true, minLength: 2, maxLength: 100 })) {
    isValid = false
  }
