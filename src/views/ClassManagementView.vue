  ...
  <div :class="['mx-auto transition-all duration-300 w-full', isSidebarCollapsed ? 'max-w-full px-3' : 'max-w-7xl px-3 lg:px-0']">
    ...
    <div class="flex flex-nowrap sm:flex-wrap gap-1 sm:gap-1.5 md:gap-2 lg:gap-3 mb-2 sm:mb-3">
      ...
      <div class="bg-white dark:bg-gray-800 rounded-sm shadow p-0.5 sm:p-1.5 md:p-2 lg:p-3 flex-1 min-w-0 min-h-[60px] sm:min-h-[70px] md:min-h-[80px]">
        <div class="flex flex-col sm:flex-row items-center sm:items-start text-center sm:text-left justify-center sm:justify-between">
          <div class="order-2 sm:order-1">
            <h3 class="text-gray-600 dark:text-gray-400 text-[10px] sm:text-xs md:text-sm font-medium mb-0.5 sm:mb-1 md:mb-2">{{ t('totalClasses') }}</h3>
            <p class="text-base sm:text-base md:text-xl lg:text-2xl xl:text-3xl font-bold leading-tight sm:leading-normal text-gray-800 dark:text-white">{{ totalClasses }}</p>
          </div>
      ...
      <div class="bg-white dark:bg-gray-800 rounded-sm shadow p-0.5 sm:p-1.5 md:p-2 lg:p-3 flex-1 min-w-0 min-h-[60px] sm:min-h-[70px] md:min-h-[80px]">
        <div class="flex flex-col sm:flex-row items-center sm:items-start text-center sm:text-left justify-center sm:justify-between">
          <div class="order-2 sm:order-1">
            <h3 class="text-gray-600 dark:text-gray-400 text-[10px] sm:text-xs md:text-sm font-medium mb-0.5 sm:mb-1 md:mb-2">{{ t('activeClasses') }}</h3>
            <p class="text-base sm:text-base md:text-xl lg:text-2xl xl:text-3xl font-bold leading-tight sm:leading-normal text-gray-800 dark:text-white">{{ activeClasses }}</p>
          </div>
      ...
      <div class="bg-white dark:bg-gray-800 rounded-sm shadow p-0.5 sm:p-1.5 md:p-2 lg:p-3 flex-1 min-w-0 min-h-[60px] sm:min-h-[70px] md:min-h-[80px]">
        <div class="flex flex-col sm:flex-row items-center sm:items-start text-center sm:text-left justify-center sm:justify-between">
          <div class="order-2 sm:order-1">
            <h3 class="text-gray-600 dark:text-gray-400 text-[10px] sm:text-xs md:text-sm font-medium mb-0.5 sm:mb-1 md:mb-2">{{ t('totalTeachers') }}</h3>
            <p class="text-base sm:text-base md:text-xl lg:text-2xl xl:text-3xl font-bold leading-tight sm:leading-normal text-gray-800 dark:text-white">{{ totalTeachers }}</p>
          </div>
      ...
      <div class="bg-white dark:bg-gray-800 rounded-sm shadow p-0.5 sm:p-1.5 md:p-2 lg:p-3 flex-1 min-w-0 min-h-[60px] sm:min-h-[70px] md:min-h-[80px]">
        <div class="flex flex-col sm:flex-row items-center sm:items-start text-center sm:text-left justify-center sm:justify-between">
          <div class="order-2 sm:order-1">
            <h3 class="text-gray-600 dark:text-gray-400 text-[10px] sm:text-xs md:text-sm font-medium mb-0.5 sm:mb-1 md:mb-2">{{ t('totalStudentsInClasses') }}</h3>
            <p class="text-base sm:text-base md:text-xl lg:text-2xl xl:text-3xl font-bold leading-tight sm:leading-normal text-gray-800 dark:text-white">{{ totalStudentsInClasses }}</p>
          </div>
      ...
      <table class="w-full">
        ...
        <thead class="bg-gray-50 dark:bg-gray-700 sticky top-0 z-10">
          <tr>
            ...
            <th class="px-2 py-3 text-center text-[10px] font-semibold text-gray-700 dark:text-gray-300 uppercase tracking-wider border-b dark:border-gray-600">{{ t('className') }}</th>
            <th class="py-3 text-center text-[10px] font-semibold text-gray-700 dark:text-gray-300 uppercase tracking-wider border-b dark:border-gray-600">{{ t('teacher') }}</th>
            ...
            <th class="py-3 text-center text-[10px] font-semibold text-gray-700 dark:text-gray-300 uppercase tracking-wider border-b dark:border-gray-600">{{ t('students') }}</th>
            <th class="py-3 text-center text-[10px] font-semibold text-gray-700 dark:text-gray-300 uppercase tracking-wider border-b dark:border-gray-600">{{ t('duration') }}</th>
        ...
        <tbody class="bg-white dark:bg-gray-800 divide-y divide-gray-200 dark:divide-gray-700">
          ...
          >
            ...
            <td class="px-3 py-3 text-xs">
              <div class="font-medium text-gray-900 dark:text-white">{{ classItem.className }}</div>
            </td>
            <td class="px-4 py-3 whitespace-nowrap text-xs text-gray-700 dark:text-gray-300 text-center">{{ classItem.teacher }}</td>
            <td class="px-4 py-3 whitespace-nowrap text-xs text-gray-700 dark:text-gray-300 text-center">{{ classItem.schedule }}</td>
            <td class="px-4 py-3 whitespace-nowrap text-xs text-gray-700 dark:text-gray-300 text-center">{{ classItem.students.length }} {{ t('students') }}</td>
            <td class="px-4 py-3 whitespace-nowrap text-xs text-gray-700 dark:text-gray-300 text-center">{{ classItem.duration }}</td>
            <td class="px-3 py-3 whitespace-nowrap">
              <span class="px-2 py-1 text-[10px] font-medium rounded-full"
                    :class="classItem.status === 'Active' ? 'bg-green-100 dark:bg-green-900 text-green-800 dark:text-green-200' : 'bg-yellow-100 dark:bg-yellow-900 text-yellow-800 dark:text-yellow-200'">
            ...
            <td class="px-4 py-3 whitespace-nowrap text-xs font-medium">
              <div class="relative">
                <button
                  @click="toggleActionMenu(classItem.id)"
                ...
                <!-- Dropdown Menu -->
                <div
                  v-if="activeActionMenu === classItem.id"
                ...
                >
                  ...
                  <button
                    @click="handleAddStudent(classItem)"
        ...
        <div class="absolute right-0 top-0 h-full w-full max-w-md bg-white dark:bg-gray-800 shadow-xl overflow-y-auto">
          ...
          <form @submit.prevent="handleSubmit" class="p-6 space-y-4">
            ...
            <div>
              ...
              />
              <p v-if="errors.className" class="mt-1 text-sm text-red-600 dark:text-red-400">{{ errors.className }}</p>
            </div>
            ...
            <div>
              ...
              />
              <p v-if="errors.teacher" class="mt-1 text-sm text-red-600 dark:text-red-400">{{ errors.teacher }}</p>
            </div>
            ...
            <div>
              ...
              />
              <p v-if="errors.schedule" class="mt-1 text-sm text-red-600 dark:text-red-400">{{ errors.schedule }}</p>
            </div>
    ...
    >
      <div class="bg-white dark:bg-gray-800 rounded-sm shadow-xl p-6 max-w-2xl w-full mx-4 max-h-[90vh] overflow-y-auto">
        <div class="flex flex-col sm:flex-row items-center sm:items-start text-center sm:text-left justify-center sm:justify-between mb-4">
          <h3 class="text-lg font-semibold text-gray-900 dark:text-white">{{ t('addStudentToClass') }}: {{ selectedClassForStudent?.className }}</h3>
          <button
          ...
          <div v-else class="divide-y divide-gray-200 dark:divide-gray-700">
            ...
            >
              ...
              <div class="flex-1">
                ...
                <div class="text-[10px] sm:text-xs text-gray-500 dark:text-gray-400">{{ student.id }} � {{ student.course }}</div>
              </div>
            </label>
          </div>
        </div>
    ...
    >
      <div class="bg-white dark:bg-gray-800 rounded-sm shadow-xl p-6 max-w-md w-full mx-4">
        <div class="flex items-center gap-4 mb-4">
          ...
          <div>
            <h3 class="text-lg font-semibold text-gray-900 dark:text-white">{{ t('update') }} {{ t('class') }}</h3>
            <p class="text-sm text-gray-600 dark:text-gray-400">{{ t('areYouSure') }} {{ t('update') }} {{ t('class') }}?</p>
          </div>
        </div>
        <p class="text-sm text-gray-700 dark:text-gray-300 mb-6">
          {{ t('class') }}: <span class="font-semibold">{{ form.className }}</span>
        </p>
        <div class="flex gap-3 justify-end">
          <button
    ...
    >
      <div class="bg-white dark:bg-gray-800 rounded-sm shadow-xl p-6 max-w-md w-full mx-4">
        <div class="flex items-center gap-4 mb-4">
          ...
          <div>
            <h3 class="text-lg font-semibold text-gray-900 dark:text-white">{{ t('deleteClass') }}</h3>
            <p class="text-sm text-gray-600 dark:text-gray-400">{{ t('areYouSure') }} {{ t('delete') }} {{ t('class') }}?</p>
          </div>
        </div>
        <p class="text-sm text-gray-700 dark:text-gray-300 mb-6">
          {{ t('class') }}: <span class="font-semibold">{{ classToDelete?.className }}</span>
        </p>
        <div class="flex gap-3 justify-end">
          <button
...
const totalTeachers = computed(() => {
  const unique = new Set(classes.value.map(c => c.teacher))
  return unique.size
})
  ...
  try {
    await withLoading(async () => {
      if (selectedClassForStudent.value && selectedStudentIds.value.length > 0) {
        const index = classes.value.findIndex(c => c.id === selectedClassForStudent.value.id)
        if (index !== -1) {
          // Add students that are not already in the class
          const existingStudents = classes.value[index].students || []
          const newStudents = selectedStudentIds.value.filter(id => !existingStudents.includes(id))
          ...
          selectedStudentIds.value = []
          studentSearchQuery.value = ''
          success(`${t('studentsAdded')}: ${newStudents.length} ${newStudents.length === 1 ? t('student') : t('students')} ${t('studentsAddedSuccess')}`)
        }
      }
    }, 'Adding students...')
  } catch (err) {
