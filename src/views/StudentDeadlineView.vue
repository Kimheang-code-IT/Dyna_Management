  ...
  <div :class="['mx-auto transition-all duration-300 w-full', isSidebarCollapsed ? 'max-w-full px-3' : 'max-w-7xl px-3 lg:px-0']">
    ...
    <div class="flex flex-nowrap sm:flex-wrap gap-1 sm:gap-1.5 md:gap-2 lg:gap-3 mb-2 sm:mb-3">
      ...
      <div class="bg-white dark:bg-gray-800 rounded-sm shadow p-0.5 sm:p-1.5 md:p-2 lg:p-3 flex-1 min-w-0 min-h-[60px] sm:min-h-[70px] md:min-h-[80px]">
        <div class="flex flex-col sm:flex-row items-center sm:items-start text-center sm:text-left justify-center sm:justify-between">
          <div class="order-2 sm:order-1">
            <h3 class="text-gray-600 dark:text-gray-400 text-[10px] sm:text-xs md:text-sm font-medium mb-0.5 sm:mb-1 md:mb-2">{{ t('totalEnrollments') }}</h3>
            <p class="text-base sm:text-base md:text-xl lg:text-2xl xl:text-3xl font-bold leading-tight sm:leading-normal text-gray-800 dark:text-white">{{ totalEnrollments }}</p>
          </div>
      ...
      <div class="bg-white dark:bg-gray-800 rounded-sm shadow p-0.5 sm:p-1.5 md:p-2 lg:p-3 flex-1 min-w-0 min-h-[60px] sm:min-h-[70px] md:min-h-[80px]">
        <div class="flex flex-col sm:flex-row items-center sm:items-start text-center sm:text-left justify-center sm:justify-between">
          <div class="order-2 sm:order-1">
            <h3 class="text-gray-600 dark:text-gray-400 text-[10px] sm:text-xs md:text-sm font-medium mb-0.5 sm:mb-1 md:mb-2">{{ t('confirmedEnrollments') }}</h3>
            <p class="text-base sm:text-base md:text-xl lg:text-2xl xl:text-3xl font-bold leading-tight sm:leading-normal text-gray-800 dark:text-white">{{ confirmedEnrollments }}</p>
          </div>
      ...
      <!-- Not Confirmed Enrollments Card -->
      <div class="bg-white dark:bg-gray-800 rounded-sm shadow p-0.5 sm:p-1.5 md:p-2 lg:p-3 flex-1 min-w-0 min-h-[60px] sm:min-h-[70px] md:min-h-[80px]">
        <div class="flex flex-col sm:flex-row items-center sm:items-start text-center sm:text-left justify-center sm:justify-between">
          <div class="order-2 sm:order-1">
            <h3 class="text-gray-600 dark:text-gray-400 text-[10px] sm:text-xs md:text-sm font-medium mb-0.5 sm:mb-1 md:mb-2">{{ t('notConfirmedEnrollments') }}</h3>
            <p class="text-base sm:text-base md:text-xl lg:text-2xl xl:text-3xl font-bold leading-tight sm:leading-normal text-gray-800 dark:text-white">{{ notConfirmedEnrollments }}</p>
          </div>
      ...
      <!-- Expired Deadlines Card -->
      <div class="bg-white dark:bg-gray-800 rounded-sm shadow p-0.5 sm:p-1.5 md:p-2 lg:p-3 flex-1 min-w-0 min-h-[60px] sm:min-h-[70px] md:min-h-[80px]">
        <div class="flex flex-col sm:flex-row items-center sm:items-start text-center sm:text-left justify-center sm:justify-between">
          <div class="order-2 sm:order-1">
            <h3 class="text-gray-600 dark:text-gray-400 text-[10px] sm:text-xs md:text-sm font-medium mb-0.5 sm:mb-1 md:mb-2">{{ t('expiredDeadlines') }}</h3>
            <p class="text-base sm:text-base md:text-xl lg:text-2xl xl:text-3xl font-bold leading-tight sm:leading-normal text-gray-800 dark:text-white">{{ expiredDeadlines }}</p>
          </div>
      ...
      <table class="w-full">
        ...
        <thead class="bg-gray-50 dark:bg-gray-700 sticky top-0 z-10">
          <tr>
            ...
            <th class="py-3 text-center text-[10px] font-semibold text-gray-700 dark:text-gray-300 uppercase tracking-wider border-b dark:border-gray-600">{{ t('className') }}</th>
            <th class="py-3 text-center text-[10px] font-semibold text-gray-700 dark:text-gray-300 uppercase tracking-wider border-b dark:border-gray-600">{{ t('totalDays') }}</th>
            <th class="py-3 text-center text-[10px] font-semibold text-gray-700 dark:text-gray-300 uppercase tracking-wider border-b dark:border-gray-600">{{ t('deadline') }}</th>
            <th class="py-3 text-center text-[10px] font-semibold text-gray-700 dark:text-gray-300 uppercase tracking-wider border-b dark:border-gray-600">{{ t('studentStatus') }}</th>
        ...
        <tbody class="bg-white dark:bg-gray-800 divide-y divide-gray-200 dark:divide-gray-700">
          <!-- No Results Found -->
          <tr v-if="filteredEnrollments.length === 0 && (searchQuery || filterDateFrom || filterDateTo)">
          ...
          >
            ...
            <td class="px-3 py-3 text-xs">
              <div class="flex items-center gap-2">
                <div class="w-10 h-10 rounded-full flex items-center justify-center overflow-hidden flex-shrink-0 bg-blue-100 dark:bg-blue-900">
                  <span class="text-blue-600 dark:text-blue-400 font-semibold text-xs">{{ getInitials(enrollment.student.name) }}</span>
                </div>
                <div class="flex-1 min-w-0">
                  <div class="font-medium text-gray-900 dark:text-white text-xs">{{ enrollment.student.name }}</div>
                  <div class="flex items-center gap-1 text-[10px] text-gray-500 dark:text-gray-400 mt-0.5">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-3 w-3" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                      <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                    </svg>
                    <span class="truncate">{{ enrollment.student.email || 'N/A' }}</span>
                  </div>
                  <div class="flex items-center gap-1 text-[10px] text-gray-500 dark:text-gray-400 mt-0.5">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-3 w-3" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                      <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" />
                    </svg>
                    <span>{{ enrollment.student.contact || 'N/A' }}</span>
                  </div>
                </div>
              </div>
            </td>
            <td class="px-4 py-3 whitespace-nowrap text-xs text-gray-700 dark:text-gray-300 text-center">{{ enrollment.className }}</td>
            <td class="px-4 py-3 whitespace-nowrap text-xs text-gray-700 dark:text-gray-300 text-center">{{ enrollment.totalDays }} {{ t('days') }}</td>
            <td class="px-4 py-3 whitespace-nowrap text-xs text-gray-700 dark:text-gray-300 text-center">{{ formatDeadline(enrollment.deadline) }}</td>
            <td class="px-3 py-3 whitespace-nowrap">
              <span class="px-2 py-1 text-[10px] font-medium rounded-full flex items-center gap-1 justify-center"
                    :class="enrollment.status === 'Confirmed' ? 'bg-green-100 dark:bg-green-900 text-green-800 dark:text-green-200' : 'bg-red-100 dark:bg-red-900 text-red-800 dark:text-red-200'">
                <svg v-if="enrollment.status === 'Not Confirmed'" xmlns="http://www.w3.org/2000/svg" class="h-3 w-3" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M6 18L18 6M6 6l12 12" />
                </svg>
                <svg v-else xmlns="http://www.w3.org/2000/svg" class="h-3 w-3" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7" />
                </svg>
                {{ enrollment.status === 'Confirmed' ? t('confirmed') : t('notConfirmed') }}
              </span>
            </td>
            <td class="px-4 py-3 whitespace-nowrap text-xs font-medium">
              <div class="flex items-center justify-center gap-2">
                <!-- View Detail Button -->
                <button
                  @click="handleViewDetail(enrollment)"
                ...
                <!-- Confirm Button -->
                <button
                  v-if="enrollment.status === 'Not Confirmed'"
                  @click="handleConfirm(enrollment)"
                ...
                <!-- Reject/Not Confirm Button -->
                <button
                  v-if="enrollment.status === 'Confirmed'"
    ...
    <Transition name="drawer">
      ...
      >
        <div class="absolute right-0 top-0 h-full w-full max-w-md bg-white dark:bg-gray-800 shadow-xl overflow-y-auto">
          ...
          <div v-if="selectedEnrollment" class="p-6 space-y-4">
            ...
            <div class="flex items-center gap-4 pb-4 border-b border-gray-200 dark:border-gray-700">
              <div class="w-16 h-16 rounded-full flex items-center justify-center bg-blue-100 dark:bg-blue-900">
                <span class="text-blue-600 dark:text-blue-400 font-semibold text-lg">{{ getInitials(selectedEnrollment.student.name) }}</span>
              </div>
              <div>
                <h3 class="text-lg font-semibold text-gray-900 dark:text-white">{{ selectedEnrollment.student.name }}</h3>
            ...
            <div class="space-y-3">
              <div>
                <label class="text-xs font-medium text-gray-500 dark:text-gray-400 uppercase">{{ t('email') }}</label>
                <p class="text-sm text-gray-900 dark:text-white mt-1">{{ selectedEnrollment.student.email || 'N/A' }}</p>
              </div>
              
              <div>
                <label class="text-xs font-medium text-gray-500 dark:text-gray-400 uppercase">{{ t('phone') }}</label>
                <p class="text-sm text-gray-900 dark:text-white mt-1">{{ selectedEnrollment.student.contact || 'N/A' }}</p>
              </div>
              
              <div>
                <label class="text-xs font-medium text-gray-500 dark:text-gray-400 uppercase">{{ t('gender') }}</label>
                <p class="text-sm text-gray-900 dark:text-white mt-1">{{ selectedEnrollment.student.gender || 'N/A' }}</p>
              </div>
              
              <div>
                <label class="text-xs font-medium text-gray-500 dark:text-gray-400 uppercase">{{ t('province') }}</label>
                <p class="text-sm text-gray-900 dark:text-white mt-1">{{ selectedEnrollment.student.province || 'N/A' }}</p>
              </div>
              
              <div>
                <label class="text-xs font-medium text-gray-500 dark:text-gray-400 uppercase">{{ t('course') }}</label>
                <p class="text-sm text-gray-900 dark:text-white mt-1">{{ selectedEnrollment.student.course || 'N/A' }}</p>
              </div>
              
              <div>
                <label class="text-xs font-medium text-gray-500 dark:text-gray-400 uppercase">{{ t('dob') }}</label>
                <p class="text-sm text-gray-900 dark:text-white mt-1">{{ formatDate(selectedEnrollment.student.dob) }}</p>
              </div>
            </div>
            ...
            <div class="pt-4 border-t border-gray-200 dark:border-gray-700 space-y-3">
              <div>
                <label class="text-xs font-medium text-gray-500 dark:text-gray-400 uppercase">{{ t('className') }}</label>
                <p class="text-sm text-gray-900 dark:text-white mt-1">{{ selectedEnrollment.className }}</p>
              </div>
              
              <div>
                <label class="text-xs font-medium text-gray-500 dark:text-gray-400 uppercase">{{ t('deadline') }}</label>
                <p class="text-sm text-gray-900 dark:text-white mt-1">{{ formatDeadline(selectedEnrollment.deadline) }}</p>
              </div>
              
              <div>
                <label class="text-xs font-medium text-gray-500 dark:text-gray-400 uppercase">{{ t('totalDays') }}</label>
                <p class="text-sm text-gray-900 dark:text-white mt-1">{{ selectedEnrollment.totalDays }} {{ t('days') }}</p>
              </div>
              
              <div>
                <label class="text-xs font-medium text-gray-500 dark:text-gray-400 uppercase">{{ t('studentStatus') }}</label>
                <p class="text-sm mt-1">
                  <span class="px-2 py-1 text-xs font-medium rounded-full"
                        :class="selectedEnrollment.status === 'Confirmed' ? 'bg-green-100 dark:bg-green-900 text-green-800 dark:text-green-200' : 'bg-red-100 dark:bg-red-900 text-red-800 dark:text-red-200'">
                    {{ selectedEnrollment.status === 'Confirmed' ? t('confirmed') : t('notConfirmed') }}
                  </span>
                </p>
              </div>
            </div>
    ...
    >
      <div class="bg-white dark:bg-gray-800 rounded-sm shadow-xl p-6 max-w-md w-full mx-4">
        ...
        <p class="text-sm text-gray-700 dark:text-gray-300 mb-6">
          {{ t('student') }}: <span class="font-semibold">{{ enrollmentToConfirm?.student.name }}</span><br>
          {{ t('className') }}: <span class="font-semibold">{{ enrollmentToConfirm?.className }}</span>
        </p>
    ...
    >
      <div class="bg-white dark:bg-gray-800 rounded-sm shadow-xl p-6 max-w-md w-full mx-4">
        ...
        <p class="text-sm text-gray-700 dark:text-gray-300 mb-6">
          {{ t('student') }}: <span class="font-semibold">{{ enrollmentToReject?.student.name }}</span><br>
          {{ t('className') }}: <span class="font-semibold">{{ enrollmentToReject?.className }}</span>
        </p>
        <div class="flex gap-3 justify-end">
          <button
...
// Load enrollments from JSON file or localStorage, then merge with student and class data
const loadEnrollments = async () => {
  try {
    const { loadDataFromJSON } = await import('../utils/dataLoader')
    
    // Load enrollments, students, and classes
    const enrollmentsData = await loadDataFromJSON('../data/enrollments.json', 'enrollments_data')
    ...
    // Merge enrollments with student and class data
    enrollments.value = enrollmentsData.map(enrollment => {
      const student = studentsData.find(s => s.id === enrollment.studentId)
      const classItem = classesData.find(c => c.id === enrollment.classId)
      
      return {
        ...enrollment,
        student: student || null,
        className: classItem ? classItem.className : enrollment.className || 'N/A'
      }
    })
...
// Generate enrollments from students and classes
const generateEnrollments = () => {
  try {
    ...
    // Create enrollments for each student-class combination
    classes.forEach(classItem => {
      if (classItem.students && Array.isArray(classItem.students)) {
        classItem.students.forEach(studentId => {
          const student = students.find(s => s.id === studentId)
          if (student) {
            // Calculate deadline (30 days from registration)
            const registeredDate = new Date(student.registered || new Date())
            const deadline = new Date(registeredDate)
            deadline.setDate(deadline.getDate() + 30)
            
            // Calculate total days
            const totalDays = Math.ceil((deadline - registeredDate) / (1000 * 60 * 60 * 24))
            
            const enrollment = {
              id: `ENR${enrollments.value.length + 1}`,
              ...
              totalDays: totalDays,
              status: 'Not Confirmed', // Default status
              created: student.registered || new Date().toISOString().split('T')[0]
            }
...
const saveEnrollments = () => {
  try {
    localStorage.setItem('enrollments_data', JSON.stringify(enrollments.value))
  } catch (error) {
...
const enrollmentToConfirm = ref(null)
...
const filteredEnrollments = computed(() => {
  ...
  if (searchQuery.value) {
    ...
    filtered = filtered.filter(e => 
      ...
      e.student.id.toLowerCase().includes(query) ||
...
const confirmedEnrollments = computed(() => {
  return enrollments.value.filter(e => e.status === 'Confirmed').length
})

const notConfirmedEnrollments = computed(() => {
  return enrollments.value.filter(e => e.status === 'Not Confirmed').length
})

const expiredDeadlines = computed(() => {
  const now = new Date()
  return enrollments.value.filter(e => {
    if (!e.deadline) return false
    return new Date(e.deadline) < now && e.status === 'Not Confirmed'
  }).length
})
...
// Handle confirm
const handleConfirm = (enrollment) => {
  enrollmentToConfirm.value = enrollment
...
const confirmEnrollment = () => {
  try {
    if (enrollmentToConfirm.value) {
      const index = enrollments.value.findIndex(e => e.id === enrollmentToConfirm.value.id)
      if (index !== -1) {
    ...
    showConfirmDialog.value = false
    handleError(err, { userMessage: 'Failed to confirm enrollment. Please try again.' })
  }
}
...
const confirmReject = () => {
  try {
    if (enrollmentToReject.value) {
      const index = enrollments.value.findIndex(e => e.id === enrollmentToReject.value.id)
      if (index !== -1) {
    ...
    showRejectDialog.value = false
    handleError(err, { userMessage: 'Failed to reject enrollment. Please try again.' })
  }
}
...
onMounted(() => {
  ...
  // Listen for storage events to refresh when students/classes change
  window.addEventListener('storage', (e) => {
    if (e.key === 'students_data' || e.key === 'classes_data') {
      generateEnrollments()
    }
    if (e.key === 'enrollments_data') {
      loadEnrollments()
    }
  })
  ...
  window.addEventListener('classesUpdated', () => {
    generateEnrollments()
  })
})

onUnmounted(() => {
  window.removeEventListener('storage', loadEnrollments)
  window.removeEventListener('studentsUpdated', generateEnrollments)
  window.removeEventListener('classesUpdated', generateEnrollments)
})
</script>
