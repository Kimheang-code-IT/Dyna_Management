              ...
              <td class="px-3 py-3 text-xs">
                <div class="flex items-center gap-2">
                  ...
                  <div>
                    ...
                    <div class="text-[10px] text-gray-500 dark:text-gray-400">{{ t('sku') }}: {{ product.sku }}</div>
                  </div>
                </div>
              </td>
...
const getCategoryColorClass = (category) => {
  const colors = {
    'Laptops': 'bg-purple-100 dark:bg-purple-900 text-purple-800 dark:text-purple-200',
    'Accessories': 'bg-blue-100 dark:bg-blue-900 text-blue-800 dark:text-blue-200',
    'Courses': 'bg-green-100 dark:bg-green-900 text-green-800 dark:text-green-200',
